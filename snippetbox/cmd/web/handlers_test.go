...
func TestShowSnippet(t *testing.T) {
	...
	// establish new test server for end-to-end tests
	ts := newTestServer(t, app.routes())
	defer ts.Close()

	// set up table tests to check responses for different URLs
	tests := []struct {
		name     string
		urlPath  string
		wantCode int
...
func TestSignupUser(t *testing.T) {
	...
	// make GET /user/signup req and extract csrf token from response body
